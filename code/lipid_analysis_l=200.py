# ## %T %n: Center-of-mass diffusion of lipids in a membrane ($L=200$)
...
for label, trajectory, ss in [('st', short_time, [10, 20]),
                              ('lt', long_time, [1, 20, 100])]:
    for s in ss:
...
#
#@image lipid_analysis/convergence_st_l=200_s=10.pdf
#@image lipid_analysis/convergence_st_l=200_s=20.pdf
#
# #### Long-time trajectory
#
#@image lipid_analysis/convergence_lt_l=200_s=1.pdf
#@image lipid_analysis/convergence_lt_l=200_s=20.pdf
#@image lipid_analysis/convergence_lt_l=200_s=100.pdf
...
#@image lipid_analysis/sampling_timestep_l=200.pdf

plot_D(dts, alphas, ds,
       t_max = 10000.,
       pdf_ds = 'lipid_analysis/D_vs_sampling_timestep_l=%d.pdf' % l)

#@image lipid_analysis/D_vs_sampling_timestep_l=200.pdf
