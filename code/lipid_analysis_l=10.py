# ## %T %n: Center-of-mass diffusion of lipids in a membrane ($L=10$)
...
for label, trajectory, ss in [('st', short_time, [20, 50, 200, 500]),
                              ('lt', long_time, [1, 50, 500, 2000])]:
    for s in ss:
...
#
#@image lipid_analysis/convergence_st_l=10_s=20.pdf
#@image lipid_analysis/convergence_st_l=10_s=50.pdf
#@image lipid_analysis/convergence_st_l=10_s=200.pdf
#@image lipid_analysis/convergence_st_l=10_s=500.pdf
#
# #### Long-time trajectory
#
#@image lipid_analysis/convergence_lt_l=10_s=1.pdf
#@image lipid_analysis/convergence_lt_l=10_s=50.pdf
#@image lipid_analysis/convergence_lt_l=10_s=500.pdf
#@image lipid_analysis/convergence_lt_l=10_s=2000.pdf
...
dts, alphas, ds = estimate_parameters(
    trajectories = [(short_time, [1, 2, 5, 10, 20, 50,
                                  100, 200, 500, 1000]),
                    (long_time, [1, 2, 5, 10, 20, 50,
...
#@image lipid_analysis/sampling_timestep_l=10.pdf

plot_D(dts, alphas, ds,
       t_max = 100000.,
       pdf_ds = 'lipid_analysis/D_vs_sampling_timestep_l=%d.pdf' % l)

#@image lipid_analysis/D_vs_sampling_timestep_l=10.pdf
