# ## %T %n: Center-of-mass diffusion of lipids in a membrane ($L=100$)
...
#
#@image lipid_analysis/convergence_st_l=100_s=20.pdf
#@image lipid_analysis/convergence_st_l=100_s=50.pdf
#
# #### Long-time trajectory
#
#@image lipid_analysis/convergence_lt_l=100_s=1.pdf
#@image lipid_analysis/convergence_lt_l=100_s=50.pdf
#@image lipid_analysis/convergence_lt_l=100_s=200.pdf
...
dts, alphas, ds = estimate_parameters(
    trajectories = [(short_time, [1, 2, 5, 10, 20, 50, 100]),
...
#@image lipid_analysis/sampling_timestep_l=100.pdf

plot_D(dts, alphas, ds,
       t_max = 10000.,
       pdf_ds = 'lipid_analysis/D_vs_sampling_timestep_l=%d.pdf' % l)

#@image lipid_analysis/D_vs_sampling_timestep_l=100.pdf
